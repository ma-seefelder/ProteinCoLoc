...
# spike/test/test_p12_lattice.jl --- P12_PENDING_SCAFFOLD, implemented by plan 12-03.
#
...
@testset "P12 lattice kernels (pending — 12-03)" begin
    @info "P12_PENDING_SCAFFOLD: spike/test/test_p12_lattice.jl is a wave-1 scaffold; plan 12-03 implements the CAR/GP kernel and DCT-II unit tests."
