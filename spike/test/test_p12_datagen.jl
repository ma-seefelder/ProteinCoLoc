...
# spike/test/test_p12_datagen.jl --- P12_PENDING_SCAFFOLD, implemented by plan 12-09.
#
...
@testset "P12 training-pool generation (pending — 12-09)" begin
    @info "P12_PENDING_SCAFFOLD: spike/test/test_p12_datagen.jl is a wave-1 scaffold; plan 12-09 implements the pool-schema and generative-order tests."
