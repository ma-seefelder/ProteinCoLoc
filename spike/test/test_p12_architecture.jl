...
# spike/test/test_p12_architecture.jl --- P12_PENDING_SCAFFOLD, implemented by plan 12-04.
#
...
@testset "P12 CNN estimator surface (pending — 12-04)" begin
    @info "P12_PENDING_SCAFFOLD: spike/test/test_p12_architecture.jl is a wave-1 scaffold; plan 12-04 implements the reshape/z-scoring and estimator-construction tests."
