...
# spike/test/test_p12_sbc.jl --- P12_PENDING_SCAFFOLD, implemented by plan 12-18.
#
...
@testset "P12 SBC row classes and rank tables (pending — 12-18)" begin
    @info "P12_PENDING_SCAFFOLD: spike/test/test_p12_sbc.jl is a wave-1 scaffold; plan 12-18 implements the row-partition, randomized-rank and uniformity tests."
