...
# spike/test/test_p12_decoupling.jl --- P12_PENDING_SCAFFOLD, implemented by plan 12-05.
#
...
@testset "P12 decoupling: src/, deps and the sealed holdout (pending — 12-05)" begin
    @info "P12_PENDING_SCAFFOLD: spike/test/test_p12_decoupling.jl is a wave-1 scaffold; plan 12-05 implements the src/-untouched, dependency-set and holdout-refusal tests."
