...
# spike/test/test_p12_result.jl --- P12_PENDING_SCAFFOLD, implemented by plan 12-12.
#
...
@testset "P12 spatial result type and its three maps (pending — 12-12)" begin
    @info "P12_PENDING_SCAFFOLD: spike/test/test_p12_result.jl is a wave-1 scaffold; plan 12-12 implements the result-type and Delta-rho structural-identity tests."
