...
# spike/test/test_p12_train.jl --- P12_PENDING_SCAFFOLD, implemented by plan 12-14.
#
...
@testset "P12 mini-spike trainer and its spend guard (pending — 12-14)" begin
    @info "P12_PENDING_SCAFFOLD: spike/test/test_p12_train.jl is a wave-1 scaffold; plan 12-14 implements the trainer, descope-routing and durability tests."
