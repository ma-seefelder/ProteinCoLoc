...
# spike/test/test_p12_prior.jl --- P12_PENDING_SCAFFOLD, implemented by plan 12-07.
#
...
@testset "P12 spatial prior and the D-05 copula (pending — 12-07)" begin
    @info "P12_PENDING_SCAFFOLD: spike/test/test_p12_prior.jl is a wave-1 scaffold; plan 12-07 implements the field-prior and golden-regression tests."
